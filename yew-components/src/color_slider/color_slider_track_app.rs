...
#[repr(C)]
#[derive(Copy, Clone, Debug, bytemuck::Pod, bytemuck::Zeroable)]
struct ColorSliderTrackUniform {
    pub color_start: [f32; 4],
    pub color_end: [f32; 4],
    pub resolution: [f32; 2],
    pub linear: u32, // boolean
}
impl Default for ColorSliderTrackUniform {
    fn default() -> Self {
        Self {
...
pub struct ColorSliderTrackApp<T: Float + AsPrimitive<f32> + ColorComponent + bytemuck::Pod> {
    ...
    uniform: ColorSliderTrackUniform,

    _marker: PhantomData<fn() -> T>,
}
impl<T: Float + AsPrimitive<f32> + ColorComponent + bytemuck::Pod> WgpuCanvasApp
    for ColorSliderTrackApp<T>
{
    type Props = ColorSliderTrackProps<T>;
        ...
        WgpuCanvasAppCreator::new(async move {
            ...
            let shader = device.create_shader_module(&wgpu::ShaderModuleDescriptor {
                ...
                source: wgpu::ShaderSource::Wgsl(
                    include_str!("color_slider_track_app.wgsl").into(),
                ),
            });
            ...
            let uniform_buffer = device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
                ...
                contents: bytemuck::cast_slice(&[ColorSliderTrackUniform::default()]),
            ...
            Self {
                ...
                uniform: ColorSliderTrackUniform::default(),
